function ritchie_pilot_2_dth_lda_with_errors(subject)
%RITCHIE_PILOT_2_DTH_LDA_WITH_ERRORS Obtain distances to the hyperplane from time-series data, 
%including trials with errors. Run the code on Ritchie 2015's data.
%
%Input: subject ID
%
