function ritchie_dth_SVM_pilot_2(subject)
%RITCHIE_DTH_SVM_PILOT_2 Performs the distance-to-hyperplane analysis using SVM on
%a balanced dataset. 
%
...
save(fullfile(results_dir,'noerrors_svm_ritchie_RTs_correct_trials'),'RT_per_condition');
end
