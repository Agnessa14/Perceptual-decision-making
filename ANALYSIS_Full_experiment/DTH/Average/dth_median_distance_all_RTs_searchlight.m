...
numConditions = 60;
numChannels = 63;
distances = NaN(max(subjects),numConditions,numTimepoints,numChannels);
...
for subject = subjects
    ...
    load(fullfile(results_dir,subname,sprintf('cross_validated_dth_pseudotrials_svm_decisionValues_searchlight_%s.mat',task_name_distance)));
