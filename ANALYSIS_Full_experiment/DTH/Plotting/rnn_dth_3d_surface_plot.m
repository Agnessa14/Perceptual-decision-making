function rnn_dth_3d_surface_plot 
%RNN_DTH_3D_SURFACE_PLOT Performs distance-to-hyperplane  using
%the distances-to-hyperplane using RNN dats. Plots in 3D: time x layer x
%correlation
%
