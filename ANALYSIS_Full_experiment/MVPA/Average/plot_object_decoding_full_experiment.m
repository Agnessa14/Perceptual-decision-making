...
% decoding_accuracies_all_subjects(isnan(decoding_accuracies_all_subjects(1,1,1,1)),:,:,:) = []; %if a subject's first datapoint is nan, assume their entire data is nans
