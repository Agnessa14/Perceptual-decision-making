...
%     [bins_dis,numBins_dis] = create_pseudotrials(numScenesPerBin,data_both_categories_dis);
    ...
    for tp1 = 1:numTimepoints 
        ...
        for tp2 = 1:numTimepoints
            disp('Test the SVM');
            testing_data  = [squeeze(data_both_categories_dis(1,testing_conditions,:,tp2)); squeeze(data_both_categories_dis(2,testing_conditions,:,tp2))];
...
save(fullfile(results_dir,subname,'time_gen_svm_artificial_vs_natural_decoding_accuracy_cross_task.mat'),'timeg_decodingAccuracy_avg');
