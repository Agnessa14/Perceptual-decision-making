function pearson_object_decoding_removed_scene(subject,task) 
...
rdm_1 = [rdm_avg(1:removed_condition-1,:,:);NaN(1,numConditionsAll-1,200);rdm_avg(removed_condition:end,:,:)];
rdm_2 = [rdm_1(:,1:removed_condition-1,:),NaN(numConditionsAll,1,200),rdm_1(:,removed_condition:end,:)];
rdm_avg = rdm_2;
