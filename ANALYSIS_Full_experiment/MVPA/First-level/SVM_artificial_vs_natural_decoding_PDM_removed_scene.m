...
save(sprintf('/home/agnek95/SMST/PDM_FULL_EXPERIMENT/RESULTS/%s/svm_artificial_vs_natural_decoding_accuracy_%s.mat',subname,task_name),'decodingAccuracy_avg');
