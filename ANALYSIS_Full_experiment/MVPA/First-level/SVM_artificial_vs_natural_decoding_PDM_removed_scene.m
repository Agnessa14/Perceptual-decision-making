function SVM_artificial_vs_natural_decoding_PDM_removed_scene(subject) 
...
for perm = 1:numPermutations
    ...
    data = create_data_matrix(numConditionsAll,triggers,numTrials,timelock_data);
...
save(sprintf('/home/agnek95/SMST/PDM_PILOT_2/RESULTS/%s/3_train_30_test_svm_artificial_vs_natural_decoding_accuracy',subname),'decodingAccuracy_avg');
