function pearson_object_decoding_full_experiment_100ms(subject,task) 
%PEARSON_OBJECT_DECODING_FULL_EXPERIMENT_100ms Perform object decoding (average of pairwise object decoding) using 1-Pearson's correlation. 
%Start from -100 ms instead of -200 ms. 
%
...
save(fullfile(results_dir,subname,sprintf('rdm_pearson_%s_100ms.mat',task_name)),'rdm_avg');
