function SVM_artificial_vs_natural_decoding_PDM_problematic(subject,task) 
...
num_conditions_per_category = numConditionsIncluded/num_categories; %works bcs we remove one artificial and one natural scene
...
for perm = 1:numPermutations
    ...
    num_bins_testing = 3;  
    testing_conditions = (numScenesPerBin*num_bins_testing)+1:numScenesPerBin*numBins-1; %a quarter of all conditions
